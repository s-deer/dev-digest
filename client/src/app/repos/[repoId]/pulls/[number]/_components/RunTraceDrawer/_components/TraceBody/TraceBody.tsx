    ...
    <>
      ...
      <TraceSection icon="FileText" title={t("trace.promptAssembly")} defaultOpen={false}>
        ...
        {trace.prompt_assembly.skills != null && (
          <PromptBlock label={`${t("trace.prompt.skills")} (${t("trace.prompt.skillsTokens", { count: trace.prompt_assembly.skills_tokens })})`} text={trace.prompt_assembly.skills} color={PROMPT_COLORS.skills} />
        )}
