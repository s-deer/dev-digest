...
lockfiles, `**/src/vendor/**` except `vendor/shared`, `server/src/db/migrations/**` (generated;
the reviewer looks at `schema.ts` instead), and deleted files.

## Routes

| Skill | Include | Exclude | Content |
|---|---|---|---|
| react-architecture | `client/src/**/*.{ts,tsx}` | `client/**/*.test.{ts,tsx}` `client/src/test/**` `client/src/vendor/**` | |
| react-best-practices | `client/src/**/*.tsx` `client/src/**/use*.ts` | `client/**/*.test.{ts,tsx}` `client/src/test/**` `client/src/vendor/**` | |
...
| next-best-practices | `client/src/**/*.{ts,tsx}` | `client/**/*.test.{ts,tsx}` `client/src/vendor/**` | `^\s*['"]use (client\|server)['"]` |
...
| zod | `server/src/**/*.ts` `client/src/**/*.{ts,tsx}` | `**/*.test.{ts,tsx}` `**/src/vendor/**` | `\bz\.(object\|enum\|union\|discriminatedUnion\|array\|string)\(` |
...
| security | `server/src/**/*.ts` `client/src/**/*.{ts,tsx}` `reviewer-core/src/**/*.ts` `scripts/**` | `**/*.test.{ts,tsx}` `**/src/vendor/**` | `dangerouslySetInnerHTML\|innerHTML\s*=\|child_process\|\bexeca\b\|\beval\(\|new Function\(\|secrets\.json\|process\.env\.\|simple-git` |
