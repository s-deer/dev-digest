...
/**
 * Test Quality Reviewer — deliberately narrow: the domain rules live in the
 * skills attached to the agent, so a run without skills flags nothing (the
 * control case of the skills experiment).
 */
...
/** API Contract Reviewer — narrow like the test-quality one; rules come from skills. */
